    ...
    <div className="space-y-20">
      ...
      >
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Detailed comparison of features across Free and Pro tiers
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <Card className="relative border-purple-200 dark:border-purple-800 shadow-lg">
            ...
            <CardHeader className="text-center pb-6">
              ...
              <p className="text-muted-foreground">Maximum analysis power</p>
            </CardHeader>
            <CardContent className="space-y-3">
              {planFeatures.pro.map((feature, index) => (
                <div key={index} className="flex items-center space-x-3">
                  ...
                  {index >= planFeatures.free.length && (
...
📁 1. COMPONENT PLACEMENT:
   - Save as: apps/web/src/pages/PricingPage.tsx
   - Ensure: apps/web/src/components/payment/PricingPlans.tsx (use pricing_plans_component-2.ts)
   - Ensure: apps/web/src/components/payment/CheckoutForm.tsx

📝 2. ROUTER INTEGRATION (apps/web/src/App.tsx):
   Add this import at top:
   import PricingPage from '@/pages/PricingPage';
   
   Add this route inside Layout Routes (after /settings):
   <Route path="/pricing" element={<PricingPage />} />

🧭 3. NAVIGATION INTEGRATION (apps/web/src/components/layout/Layout.tsx):
   Update navigation array around line 25:
   
   const navigation = [
     { name: 'Home', href: '/', icon: Home },
     { name: 'Analyze', href: '/analyze', icon: Zap },
     { name: 'Dashboard', href: '/dashboard', icon: BarChart3 },
     { name: 'Pricing', href: '/pricing', icon: Crown },  // ADD THIS LINE
     { name: 'Settings', href: '/settings', icon: Settings },
   ];

   Add Crown import at top:
   import { 
     ..., 
     Crown,  // ADD THIS
     ...
...
💳 4. UPGRADE BUTTON ENHANCEMENT (apps/web/src/components/layout/Layout.tsx):
   Update "Upgrade to Pro" button around line 180:
...
✅ 5. EXPECTED RESULTS:
   ✅ /pricing route accessible and functional
   ✅ Navigation menu shows "Pricing" with Crown icon
   ✅ "Upgrade to Pro" button links to pricing page
   ✅ Complete Stripe payment integration working
   ✅ SEO optimization active for pricing page
   ✅ Analytics tracking revenue funnel
   ✅ Professional design with conversion optimization
   ✅ Immediate revenue generation capability

📊 REVENUE IMPACT: IMMEDIATE COMMERCIAL CAPABILITY
*/